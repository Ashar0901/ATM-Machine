...
if (answer.pin === userpin) {
  ...
  if (paymentmode.transactiontype === "Fastcash") {
    ...
    if(cashfast>=mybalance){console.log("You Have insufficient Balance in your account")}

else if(mybalance-=cashfast){console.log(`"your remaining balance is ${mybalance}"`)}    
  } 
...
if(withdraw>=mybalance){console.log(`"You Have insufficient balance in your account"`)}
else if(mybalance-=withdraw){console.log(`"Your remaining balance is ${mybalance}"`)}
